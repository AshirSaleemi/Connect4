//  Authors Jay Patel (Jpate260), and Ashir Saleemi(asalee20).
//  UIC CS342 Project 2
// 	This program is Connect Four this will have 3 different scenes a welcome screen
//  gamescreen and end screen. The objective of this game is to get four in a row of 
//  the same color, in order to win it can be diagonal, horizontal or vertical. This game
